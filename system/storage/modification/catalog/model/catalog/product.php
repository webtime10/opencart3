...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
		...
		if (!empty($data['filter_wt_filter'])) {
			...
			if (method_exists($this->model_catalog_wt_filter, 'getProductSQL')) {
