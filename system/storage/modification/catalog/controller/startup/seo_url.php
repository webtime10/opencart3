...
class ControllerStartupSeoUrl extends Controller {
	...
	//seopro start
		...
		public function __construct($registry) {
			...
			// WT Lang start — detect URL prefix before SeoPro language detection
			if (is_file(DIR_APPLICATION . 'controller/extension/module/wt_lang.php')) {
				$this->load->controller('extension/module/wt_lang/detectRoute');
			}
			// WT Lang end
	...
	public function index() {
		...
		if ($this->config->get('config_seo_url')) {
			...
			// WT Lang start
			if (!is_null($this->registry->get('wt_lang'))) {
				$this->url->addRewrite($this->registry->get('wt_lang'));
			}
			// WT Lang end
		}
