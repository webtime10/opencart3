	...
	public function index() {
		...
		if ($category_info) {
			...
			$filter_data = array(
				...
				'filter_wt_filter'   => $filter_wt_filter,
				'sort'               => $sort,
				'order'              => $order,
				'start'              => ($page - 1) * $limit,
				'limit'              => $limit
