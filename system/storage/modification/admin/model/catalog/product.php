...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (method_exists($this->model_catalog_wt_filter, 'saveProductFilterValues')) {
			$this->model_catalog_wt_filter->saveProductFilterValues($product_id, $data);
		}
